...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
    'https://github.com/timloden/CAWeb-Standard',
    __FILE__,
    'CAWeb-Standard'
);
...
require_once 'acf-addons/acf-fonticonpicker/acf-fonticonpicker.php';
require_once 'acf-addons/acf-code-field/acf-code-field.php';
