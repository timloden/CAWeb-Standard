...
function caweb_theme_activate()
{
    ...
    if(get_option('caweb_theme_activated') != '1' && get_option('caweb_initialized') === '1') {
        ...
        $fields = array(
        'ca_google_analytic_id' => 'google_analytics',
        'ca_google_search_id' => 'google_search_engine_id',

        'ca_frontpage_search_enabled' => 'general_settings_show_search_on_front_page',
        'ca_google_trans_enabled' => 'google_enable_google_translate',
        'ca_contact_us_link' => 'utility_header_contact_us_page',
        'ca_geo_locator_enabled' => 'utility_header_enable_geo_locator',
        'ca_google_meta_id' => 'google_meta_id',
        'ca_custom_css' => 'custom_css',
        'ca_social_facebook' => 'facebook_url',
        'ca_social_facebook_header' => 'facebook_show_in_header',
        'ca_social_facebook_footer' => 'facebook_show_in_footer',
        'ca_social_facebook_new_window' => 'facebook_open_in_new_tab',
        'ca_social_twitter' => 'twitter_url',
        'ca_social_twitter_header' => 'twitter_show_in_header',
        'ca_social_twitter_footer' => 'twitter_show_in_footer',
        'ca_social_twitter_new_window' => 'twitter_open_in_new_tab',
        'ca_social_email' => 'share_via_email',
        'ca_social_email_header' => 'share_via_email_show_in_header',
        'ca_social_email_footer' => 'share_via_email_show_in_footer',
        'ca_social_flickr' => 'flickr_url',
        'ca_social_flickr_header' => 'flickr_show_in_header',
        'ca_social_flickr_footer' => 'flickr_show_in_footer',
        'ca_social_flickr_new_window' => 'flickr_open_in_new_tab',
        'ca_social_pinterest' => 'pinterest_url',
        'ca_social_pinterest_header' => 'pinterest_show_in_header',
        'ca_social_pinterest_footer' => 'pinterest_show_in_footer',
        'ca_social_pinterest_new_window' => 'pinterest_open_in_new_tab',
        'ca_social_youtube' => 'youtube_url',
        'ca_social_youtube_header' => 'youtube_show_in_header',
        'ca_social_youtube_footer' => 'youtube_show_in_footer',
        'ca_social_youtube_new_window' => 'youtube_open_in_new_tab',
        'ca_social_instagram' => 'instagram_url',
        'ca_social_instagram_header' => 'instagram_show_in_header',
        'ca_social_instagram_footer' => 'instagram_show_in_footer',
        'ca_social_instagram_new_window' => 'instagram_open_in_new_tab',
        'ca_social_linkedin' => 'linkedin_url',
        'ca_social_linkedin_header' => 'linkedin_show_in_header',
        'ca_social_linkedin_footer' => 'linkedin_show_in_footer',
        'ca_social_linkedin_new_window' => 'linkedin_open_in_new_tab',
        'ca_social_rss' => 'rss_url',
        'ca_social_rss_header' => 'rss_show_in_header',
        'ca_social_rss_footer' => 'rss_show_in_footer',
        'ca_social_rss_new_window' => 'rss_open_in_new_tab',
        'ca_home_nav_link' => 'utility_header_home_link_in_utility_header',
        'ca_utility_link_1' => 'utility_header_custom_link_1_custom_link_1_url',
        'ca_utility_link_2' => 'utility_header_custom_link_2_custom_link_2_url',
        'ca_utility_link_3' => 'utility_header_custom_link_3_custom_link_3_url',
        'ca_utility_link_1_name' => 'utility_header_custom_link_1_custom_link_1_text',
        'ca_utility_link_2_name' => 'utility_header_custom_link_2_custom_link_2_text',
        'ca_utility_link_3_name' => 'utility_header_custom_link_3_custom_link_3_text',
        'ca_utility_link_1_new_window' => 'utility_header_custom_link_1_open_custom_link_1_in_new_tab',
        'ca_utility_link_2_new_window' => 'utility_header_custom_link_2_open_custom_link_2_in_new_tab',
        'ca_utility_link_3_new_window' => 'utility_header_custom_link_3_open_custom_link_3_in_new_tab',
        'ca_google_trans_page' => 'google_custom_translate_translate_page_url',
        'ca_google_trans_icon' => 'google_custom_translate_translate_icon',
        'ca_google_trans_enabled' => 'google_enable_google_translate',
